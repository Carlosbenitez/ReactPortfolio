    ...
    return (
        <>
            <div className="row text-center"><div className="col-md-3 col-centered">
                <img id="profilepic" src="img/Profilepicture.jfif" alt="A photo of me." className="w-100" />
            </div>
            </div>
            <br />
            <div id="contentback">
         ...
         link with me on my professional websites below.
                ...
                <div className="row">
                    ...
                    <div className="col-sm-12 col-md-4 col-lg-4">
                        <div className="content">
                            <img className="profilepics" src="img/Portfolio.jpg" alt="Portfolio screenshot" />
                            <h3>Portfolio</h3>
