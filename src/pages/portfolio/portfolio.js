...
function Portfolio() {
    const cardInfo = [
        ...
        { image: rogue, title: "Rogue Blitz", text: "I had the privledge to work on an application that was a retro game called Rogue Blitz. My group utilized a library called Phaser to animate sprites and add physics. It is a horde-style game that has you battling to earn the highest score. I was responsible for enemy creation and the UI. Think you can beat my high score? Give it a try!", site: "https://rogueblitzgaming.herokuapp.com/", alt: "My Second Project" },

        { image: burger, title: "Burger Logger", text: "Do you have a list of burgers to eat? Then this is the app for you. Store new burgers to a list or add ones you have already devoured. Once you have eaten a saved burger mark it as devoured. Lose interest or regret devouring it? Just delete it.", site: "https://burger-app-cjb.herokuapp.com/", alt: "My Burger Logger" },
